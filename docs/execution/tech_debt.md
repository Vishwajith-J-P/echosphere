...
|---|---|---|---|---|
| TD-001 | Persistence | Session state and caller capabilities are process-local and disappear on restart | High | OPEN |
...
- TD-001: implement Phase 1 SQLite repositories and expiring hashed capabilities before restart/recovery claims.
